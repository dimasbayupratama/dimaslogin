...
class auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config = array(
            ...
            'smtp_user'   => '30dimasprata@gmail.com',
        ...
        $this->email->from('30dimasprata@gmail.com', 'oke Kamu losh');
    ...
    public function resetPassword()
    {
        ...
        if ($user) {
            $user_token = $this->db->get_where('user_token', array('token' =>
            $token))->row_array();
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata(
                'message',
                '<div class="alert alert-success" 
            role="alert">Password ha been changed! Please login.</div>'
            );
            redirect('auth');
        }
    }
